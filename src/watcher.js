...
function generateTheme() {
  ...
  fs.writeFile('themes/blankeos-zen-theme.json', schema(base), (err) => err && console.log(err))
  fs.writeFile('themes/blankeos-zen-dark-theme.json', schema(storm), (err) => err && console.log(err))
